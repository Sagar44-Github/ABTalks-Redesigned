...
//#region node_modules/.nitro/vite/services/ssr/assets/server-So0GBSqD.js
var server_So0GBSqD_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D61AehgK.mjs");
...
var manifest = {
	"221f9ae60ee323c1faecbeafc587abdeedee4b9bf18c3d3dd9f56e83ebe08763": {
		functionName: "getAiFeedback_createServerFn_handler",
		importer: () => import("./ai-Pq1lIVSp.mjs")
	},
	"d9500dcd8a12e465b5fcfe1a83e410407a63171b81adcd27c1a50504ed103079": {
		functionName: "getAiPitch_createServerFn_handler",
		importer: () => import("./ai-Pq1lIVSp.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-N6lz0OtS.mjs").then((n) => n.s).then((n) => n.t),
...
//#endregion
export { server_So0GBSqD_exports as i, createServerFn as n, getServerFnById as r, TSS_SERVER_FUNCTION as t };
